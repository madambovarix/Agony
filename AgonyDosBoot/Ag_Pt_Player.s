...
* Master_Volume (0 to 64) Is the general song volume (4voices)
* put it at 64 when you call mt_init and/or use it to make fade in/out
* ------------
...
mt_NoNewAllChannels
	...
	MOVE	#-1,Voice_Volume
	BSR	mt_CheckEfx
	MOVE	Voice_Volume,d0
	bmi	.no0
	MOVE	Voice_Volume,Voice0_Volume
.no0
	MOVE	Voice0_Volume,d0
	sub	#64,d0
	add	Master_Volume,d0
	bpl	.ok0
	moveq	#0,d0
.ok0
	MOVE	D0,8(a5)
	...
	MOVE	Voice_Volume,d0
	bmi	.no1
	MOVE	Voice_Volume,Voice1_Volume
.no1
	MOVE	Voice1_Volume,d0
	sub	#64,d0
	add	Master_Volume,d0
	bpl	.ok1
	moveq	#0,d0
.ok1
	...
	MOVE	Voice_Volume,d0
	bmi	.no2
	MOVE	Voice_Volume,Voice2_Volume
.no2
	MOVE	Voice2_Volume,d0
	sub	#64,d0
	add	Master_Volume,d0
	bpl	.ok2
	moveq	#0,d0
.ok2
	...
	MOVE	Voice_Volume,d0
	bmi	.no3
	MOVE	Voice_Volume,Voice3_Volume
.no3
	MOVE	Voice3_Volume,d0
	sub	#64,d0
	add	Master_Volume,d0
	bpl	.ok3
	moveq	#0,d0
